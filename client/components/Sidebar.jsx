...
export default function SidebarComponent() {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const username = localStorage.getItem('username'); // Get the username from localStorage or other source
  ...
  const handleLogout = async () => {
    try {
      // Call your backend API to logout, or just clear the local storage
